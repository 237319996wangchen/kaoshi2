...
//    const ANSWER_TYPE_TEXT  = 4; // 填空
    ...
    {
        $array = [
            self::ANSWER_TYPE_ONE   => '单选题',
//            self::ANSWER_TYPE_JUDGE => '判断',
            self::ANSWER_TYPE_MULTI => '多选题',
...
//            self::ANSWER_TYPE_TEXT  => '问答题，请填写你的答案'
    ...
    public function rules()
    {
        return [
            ...
            [['answer_type', 'status', 'created_at', 'updated_at', 'course_id', 'guan_id', 'special_id', 'error_number', 'do_number'], 'integer'],
        ];
    }
